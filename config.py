...
# =========================================
MESSAGES = {
    # --- คำอธิบายคำสั่ง (Command Descriptions) ---
    ...
    "desc_restock": "เติมของ/แก้ไขข้อมูลตู้กาชา (Restock)", # <--- บรรทัดนี้ที่ขาดไปครับ
    ...
    "gam_ph_name": "เช่น สกิน 512, แอดออนฟรี",
