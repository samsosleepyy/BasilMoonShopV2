...
MESSAGES = {
    ...
    # [NEW] Special Logic Message
    "gam_err_special_locked": "🔒 **โซนพิเศษยังไม่ปลดล็อค!**\nต้องสุ่มของทั่วไป (1-10) ให้หมดเกลี้ยงก่อน ถึงจะลุ้นรางวัลพิเศษ (11-15) ได้",

    # [UPDATED] Enhanced Log (User Stats)
...
def load_data():
    if not os.path.exists(DATA_FILE):
        return {
            ...
            "gamble_configs": {}, # {msg_id: config_dict} [NEW] เก็บ Config ของแต่ละตู้
            "gamble_stats": {}    # {msg_id: {user_id: count}} [NEW] นับจำนวนการสุ่มของ user
        }
