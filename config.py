...
MESSAGES = {
    ...
    "gam_err_sold_out": "❌ สินค้าหมดเกลี้ยงแล้ว! (Sold Out)", # ข้อความเมื่อของหมดทุกชิ้น
    ...
    "play_result_desc": "คุณได้รับ: **{prize_name}**", # [NEW] ใช้ชื่อสินค้าแทน rank
