...
MESSAGES = {
    ...
    "desc_selectmenu": "สร้างเมนูเลือกรายการ (Dropdown) สูงสุด 20 ช่อง", # [NEW]

    # --- Select Menu System [NEW] ---
    ...
    # ... (ส่วนอื่นๆ ของ Point, Admin, Gamble, Auction, Ticket คงเดิมทั้งหมด) ...
    ...
    "auc_img_received": "📥 ได้รับรูปสินค้าเรียบร้อย ตรวจสอบและยืนยัน ⏳",
    ...
    "ar_log_title": "🚨 ตรวจพบการสร้าง Webhook ผิดปกติ! (Raid Attempt)",
...
def load_data():
    default_structure = {
        ...
        "select_menus": {} # [NEW] Store Select Menu Configs
    }
...
def init_guild_data(data, guild_id):
    ...
    elif "antiraid" not in data["guilds"][str_id]:
         data["guilds"][str_id]["antiraid"] = {"status": False, "log_channel": None}
    return data
