...
MESSAGES = {
    ...
    # Log กรณี Admin สร้าง (Safe)
    "ar_log_title_safe": "🛡️ มีการสร้าง Webhook (โดยผู้ดูแล)",
    "ar_log_desc_safe": "สร้างโดยผู้ได้รับอนุญาต",
    ...
    "desc_restock": "เติมของ/แก้ไขข้อมูลตู้กาชา",
    ...
    "gam_lbl_img1": "ลิ้งค์รูปปก",
    "gam_lbl_img2": "ลิ้งค์รูปตอนสุ่ม",
...
def init_guild_data(data, guild_id):
    ...
    if str_id not in data["guilds"]:
        data["guilds"][str_id] = {
            ...
            "gamble_configs": {},
            "gamble_stats": {},
            "antiraid": {"status": False, "log_channel": None}
        }
    # Migration for antiraid
