...
MESSAGES = {
    ...
    "desc_antiraid": "เปิด/ปิด ระบบป้องกันการสร้าง Webhook (Anti-Raid)", # [NEW]

    # --- Anti-Raid System [NEW] ---
    "ar_enabled": "✅ **เปิดระบบ Anti-Raid Webhook** เรียบร้อยแล้ว\nช่องแจ้งเตือน: {channel}",
    "ar_disabled": "❌ **ปิดระบบ Anti-Raid Webhook** แล้ว",
    "ar_log_title": "🛡️ ตรวจพบการสร้าง Webhook ผิดปกติ!",
    "ar_log_desc": "ระบบได้ทำการลบ Webhook และระงับสิทธิ์ผู้ใช้รายนี้แล้ว",
    "ar_field_user": "👤 ผู้กระทำ",
    "ar_field_webhook": "🔗 Webhook ที่สร้าง",
    "ar_field_action": "⚙️ การดำเนินการ",
    "ar_action_taken": "✅ ลบ Webhook + ปิดสิทธิ์การสร้าง",
...
def init_guild_data(data, guild_id):
    ...
    if str_id not in data["guilds"]:
        data["guilds"][str_id] = {
            ...
            "gamble_configs": {},
            "gamble_stats": {},
            "antiraid": {"status": False, "log_channel": None} # [NEW]
        }
    # Check if antiraid exists in existing guild data
